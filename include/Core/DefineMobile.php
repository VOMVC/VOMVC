...
class DefineMobile
{
    ...
    public function __construct(
		...
		($this->isMobile() ? ($this->isTablet() ? define('TABLET',true) : define('PHONE',true)) : define('COMPUTER',true));
		defined('TABLET')?:define('TABLET',false);
		defined('PHONE')?:define('PHONE',false);
		defined('COMPUTER')?:define('COMPUTER',false);
    }
